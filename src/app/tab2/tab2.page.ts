...
import { IonHeader, IonToolbar, IonTitle, IonContent,IonIcon,
  IonList, IonLabel, IonItem,IonModal,IonDatetime, IonNote,
...
@Component({
  ...
  standalone:true,
  imports: [IonHeader, IonToolbar, IonTitle, IonContent, IonList, IonModal,
    IonLabel, IonItem, IonDatetime, IonNote, IonIcon, NgStyle, DatePipe,
  IonRefresher, IonRefresherContent, NgFor, NgIf]
})
