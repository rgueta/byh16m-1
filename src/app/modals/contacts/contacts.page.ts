...
import { IonContent, IonHeader, IonTitle, IonToolbar, ModalController,
  AlertController,LoadingController,IonText,IonLabel,IonImg,IonAvatar,
  IonIcon, IonItem,IonList,IonButtons
 } 
...
import { peopleCircleOutline,arrowBackCircleOutline} from 'ionicons/icons';
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, IonAvatar,
    CommonModule, FormsModule, IonText, IonLabel, IonImg, IonIcon,
    IonItem,IonList,IonButtons,NgFor, NgIf,ReactiveFormsModule
  ]
})
export class ContactsPage implements OnInit {
  ...
  constructor(private modalController : ModalController,
        ...
        addIcons({peopleCircleOutline,arrowBackCircleOutline });
   }
