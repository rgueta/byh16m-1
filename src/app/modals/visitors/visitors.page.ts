...
import { FormsModule,FormControl,Validators,FormGroup,
   ReactiveFormsModule, 
   FormBuilder} from '@angular/forms';
import { IonContent, IonHeader, IonTitle, IonToolbar,ModalController,
        ToastController,AnimationController,IonButton,IonItem,IonLabel,
        IonSelectOption,IonInput,IonSelect,IonCardContent,
        IonCard,IonIcon,IonButtons
...
@Component({
  ...
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, IonLabel,
    CommonModule, FormsModule, IonButton,IonItem,IonSelectOption,
    IonInput,IonSelect,ReactiveFormsModule,IonSelect,
    IonCardContent,IonCard,IonIcon,IonButtons
  ]
})
