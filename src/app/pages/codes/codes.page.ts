...
import { UpdCodesModalPage } 
  from '../../modals/upd-codes-modal/upd-codes-modal.page';
...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonLabel,
  IonItem, IonDatetime, IonModal,IonIcon,IonNote,IonRange,
  IonList, IonFabButton, IonFab, IonRefresherContent,
  IonRefresher, ModalController
 } from '@ionic/angular/standalone';
 import { addIcons } from 'ionicons';
 import { chevronUpOutline, chevronDownOutline,calendarOutline, 
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonLabel,IonItem,
    IonToolbar, CommonModule, FormsModule, IonDatetime,IonModal,
    IonIcon, IonNote, IonRange,IonList, IonFabButton, IonFab,
...
export class CodesPage implements OnInit {
  ...
  constructor(public api : DatabaseService,
     ...
     addIcons({chevronUpOutline, chevronDownOutline,calendarOutline, 
